...
public class GameGUI implements MouseMotionListener, MouseListener {
    ...
    public JPanel myTurn;
    public JButton canon;
    ...
    private void createTemplates() {
        ...
        int[] d9 = {182, 253, 267, 264, 286, 291, 306, 325, 304, 55, 93, 148, 153, 91, 77, 96, 36, 348};
        int[] e9 = {213, 253, 271, 320, 337, 332, 259, 56, 122, 165, 144, 97, 64, 53};
        int[] f9 = {234, 269, 289, 311, 318, 295, 43, 110, 161, 92, 74, 63, 54};
        int[] g92 = {183, 231, 260, 271, 270, 293, 324, 333, 330, 288, 71, 121, 150, 124, 88, 71};
        int[] h92 = {217, 239, 246, 286, 297, 288, 337, 323, 274, 81, 119, 156, 150, 121, 85, 87, 41};
        ...
        int[] g5 = {183, 189, 281, 285, 284, 276, 282, 313, 301, 294, 279, 272, 245, 236};
        int[] h5 = {184, 183, 198, 299, 317, 315, 299, 302, 297, 278, 254, 262, 256, 248, 247, 237, 246};
        int[] i5 = {183, 188, 265, 295, 311, 293, 278, 298, 269, 278, 273, 281, 259, 234};
        int[] j5 = {186, 181, 181, 190, 305, 325, 302, 295, 306, 271, 264, 245, 245, 241};
        int[] k5 = {185, 186, 180, 298, 316, 297, 285, 278, 287, 275, 278, 284, 275, 246};
        int[] l5 = {180, 180, 174, 278, 303, 285, 311, 332, 296, 234, 259, 265, 241, 242};
        int[] m5 = {193, 206, 207, 263, 304, 312, 324, 338, 340, 255, 227, 222, 237};
        int[] n5 = {199, 202, 218, 268, 296, 300, 306, 318, 337, 339, 217, 202, 230};
        int[] o5 = {188, 193, 197, 226, 262, 316, 323, 286, 301, 282, 263, 239, 258, 266, 278, 275};
        int[] p5 = {177, 195, 260, 279, 253, 265, 267, 285, 301, 303, 302, 267, 249, 253, 270, 272};
        ...
        int[] m6 = {204, 226, 241, 275, 291, 322, 334, 340, 305, 203, 200, 196};
        int[] n6 = {196, 222, 220, 238, 266, 293, 324, 338, 333, 228, 186, 189};
        templatesF.add(g6);
        templatesF.add(h6);
        templatesF.add(i6);
        templatesF.add(j6);
        ...
        int[] o9 = {174, 170, 174, 175, 181, 181, 181};
        int[] q9 = {177, 184, 181, 182, 182, 182, 181, 181};
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        canon = new JButton();
        canon.setText("Canon");
        myTurn.add(canon, new GridConstraints(3, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
